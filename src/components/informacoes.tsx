...
const InformationSection = () => {
  const navigate = useNavigate(); // 2. Obtenha a função de navegação

  // 3. Substitua 'action' por 'path' nos seus dados
  const informationPanels = [
    ...
    },
    {
      ...
      path: '/presentes' // Direciona para a rota /presentes
    },
    {
      id: 'dicas',
  ...
  return (
    <section id="dicas" className="h-screen bg-background flex flex-col">
      <div className="flex-1 flex flex-col justify-center">
        ...
        {/* Banner Horizontal com 4 Painéis */}
          ...
          {informationPanels.map((panel) => (
            ...
            >
              ...
              <div className="absolute bottom-4 sm:bottom-6 left-1/2 transform -translate-x-1/2 w-full px-3 sm:px-4">
                <Button 
                  // 4. Mude o onClick do botão para usar navigate(panel.path)
